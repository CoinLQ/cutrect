# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-01-06 15:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ttype', models.PositiveSmallIntegerField(choices=[(2, '置信度'), (1, '顺序校对'), (3, '聚类'), (4, '差缺补漏')], db_index=True, default=1, verbose_name='切分方式')),
                ...
                ('priority', models.PositiveSmallIntegerField(choices=[(1, '低'), (3, '中'), (5, '高'), (7, '最高')], default=3, verbose_name='任务状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_cnt', models.IntegerField(default=0, verbose_name='总数')),
                ('needcheck_cnt', models.IntegerField(default=0, verbose_name='待检查数')),
                ('done_cnt', models.IntegerField(default=0, verbose_name='已完成数')),
                ('wcc_threshold', models.DecimalField(db_index=True, decimal_places=3, default=0, max_digits=4, verbose_name='识别置信阈值')),
            ],
        ),
        migrations.CreateModel(
            name='ClassifyTask',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(max_length=64, null=True, verbose_name='关联源页CODE')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verifier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='verify_patches', to='jwt_auth.Staff', verbose_name='审定人')),
            ],
            options={
                'ordering': ('ch',),
                'verbose_name': 'Patch',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('cid', models.CharField(blank=True, default='', max_length=40, null=True, verbose_name='经字号')),
                ('op', models.PositiveSmallIntegerField(default=1, verbose_name='操作类型')),
                ('x', models.PositiveSmallIntegerField(default=0, verbose_name='X坐标')),
                ('y', models.PositiveSmallIntegerField(default=0, verbose_name='Y坐标')),
                ...
                ('s3_inset', models.FileField(blank=True, max_length=256, null=True, storage='storages.backends.s3boto.S3BotoStorage', upload_to='tripitaka/hans', verbose_name='s3地址')),
                ('pcode', models.CharField(max_length=64, null=True, verbose_name='关联源页CODE')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('page_rect', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rects', to='rect.PageRect', verbose_name='源页切分集')),
            ],
            options={
                'ordering': ('-cc',),
                'verbose_name': '源-切字块',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('schedule_no', models.CharField(default='', max_length=64, verbose_name='切分计划批次')),
                ('cc_threshold', models.FloatField(default=0.65, verbose_name='切分置信度阈值')),
                ('wcc_threshold', models.FloatField(default=0.75, verbose_name='聚类置信度阈值')),
                ...
                ('reels', models.ManyToManyField(to='rect.Reel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sid', models.CharField(max_length=10, verbose_name='实体藏经|唯一经号编码')),
        ...
        migrations.AddField(
            model_name='ocolumn',
            name='page',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ocolumns', to='rect.Page', verbose_name='原始页'),
        ),
        migrations.AddField(
            model_name='deltask',
            name='schedule',
