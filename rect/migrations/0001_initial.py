# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-01-07 01:10
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='OColumn',
            fields=[
                ('oclid', models.CharField(max_length=25, primary_key=True, serialize=False, verbose_name='页的切列编码')),
                ('line_no', models.PositiveSmallIntegerField(default=1, verbose_name='行号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_no', models.IntegerField(default=1, verbose_name='册级页序号')),
        ...
        migrations.CreateModel(
            name='Rect',
            fields=[
                ('cid', models.CharField(max_length=28, primary_key=True, serialize=False, verbose_name='经字号')),
                ('page_code', models.CharField(max_length=23, verbose_name='关联源页CODE')),
                ('column_code', models.CharField(max_length=25, null=True, verbose_name='关联源页切列图CODE')),
                ('char_no', models.PositiveSmallIntegerField(blank=True, default=0, null=True, verbose_name='字号')),
                ('line_no', models.PositiveSmallIntegerField(blank=True, default=0, null=True, verbose_name='行号')),
                ('op', models.PositiveSmallIntegerField(default=1, verbose_name='操作类型')),
                ('x', models.PositiveSmallIntegerField(default=0, verbose_name='X坐标')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reel_no', models.CharField(max_length=3, verbose_name='经卷序号编码')),
                ('ready', models.BooleanField(default=False, verbose_name='已准备好')),
                ('image_ready', models.BooleanField(default=False, verbose_name='图源状态')),
                ('image_upload', models.BooleanField(default=False, verbose_name='图片上传状态')),
                ('txt_ready', models.BooleanField(default=False, verbose_name='文本状态')),
