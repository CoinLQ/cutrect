# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2017-12-22 20:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.TextField(blank=True, null=True, verbose_name='计划格式化描述')),
                ('user_group', models.CharField(blank=True, db_index=True, max_length=64, null=True, verbose_name='分配组')),
                ('status', models.PositiveSmallIntegerField(choices=[(0, '未激活'), (1, '已激活'), (2, '已过期'), (3, '已作废'), (4, '已完成')], db_index=True, default=1, verbose_name='计划状态')),
        ...
        migrations.CreateModel(
            name='CCTask',
            fields=[
                ('task_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='rect.Task')),
        ...
        migrations.AddField(
            model_name='task',
            name='schedule',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tasks', to='rect.Schedule', verbose_name='切分计划'),
        ),
    ]
